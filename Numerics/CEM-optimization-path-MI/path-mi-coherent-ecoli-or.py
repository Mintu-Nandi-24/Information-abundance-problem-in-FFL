# =============================================================================
# FILE: Numerics/CEM-optimization-path-MI/path-mi-coherent-ecoli-or.py
...
#   ($I_{\mathrm{path}}(X;Z)$) for coherent FFLs in *E. coli* with an OR
...
#   Run: python path-mi-coherent-ecoli-or.py
#
# OUTPUTS
