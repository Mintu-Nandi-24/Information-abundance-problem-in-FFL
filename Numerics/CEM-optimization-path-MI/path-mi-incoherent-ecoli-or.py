# =============================================================================
# FILE: Numerics/CEM-optimization-path-MI/path-mi-incoherent-ecoli-or.py
...
#   ($I_{\mathrm{path}}(X;Z)$) for incoherent FFLs in *E. coli* with an OR
...
#   Run: python path-mi-incoherent-ecoli-or.py
#
# OUTPUTS
