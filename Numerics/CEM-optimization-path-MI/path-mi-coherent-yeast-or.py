# =============================================================================
# FILE: Numerics/CEM-optimization-path-MI/path-mi-coherent-yeast-or.py
...
#   ($I_{\mathrm{path}}(X;Z)$) for coherent FFLs in *S. cerevisiae* / yeast with an OR
...
#   Run: python path-mi-coherent-yeast-or.py
#
# OUTPUTS
