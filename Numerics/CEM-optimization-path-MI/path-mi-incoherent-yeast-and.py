# =============================================================================
# FILE: Numerics/CEM-optimization-path-MI/path-mi-incoherent-yeast-and.py
...
#   ($I_{\mathrm{path}}(X;Z)$) for incoherent FFLs in *S. cerevisiae* / yeast with an AND
...
#   Run: python path-mi-incoherent-yeast-and.py
#
# OUTPUTS
