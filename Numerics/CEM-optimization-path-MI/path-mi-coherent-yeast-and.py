# =============================================================================
# FILE: Numerics/CEM-optimization-path-MI/path-mi-coherent-yeast-and.py
...
#   ($I_{\mathrm{path}}(X;Z)$) for coherent FFLs in *S. cerevisiae* / yeast with an AND
...
#   Run: python path-mi-coherent-yeast-and.py
#
# OUTPUTS
