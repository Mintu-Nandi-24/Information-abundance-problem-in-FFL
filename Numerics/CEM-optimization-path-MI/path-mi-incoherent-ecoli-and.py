# =============================================================================
# FILE: Numerics/CEM-optimization-path-MI/path-mi-incoherent-ecoli-and.py
...
#   ($I_{\mathrm{path}}(X;Z)$) for incoherent FFLs in *E. coli* with an AND
...
#   Run: python path-mi-incoherent-ecoli-and.py
#
# OUTPUTS
