# =============================================================================
# FILE: Numerics/CEM-optimization-path-MI/path-mi-coherent-ecoli-and.py
...
#   ($I_{\mathrm{path}}(X;Z)$) for coherent FFLs in *E. coli* with an AND
...
#   Run: python path-mi-coherent-ecoli-and.py
#
# OUTPUTS
