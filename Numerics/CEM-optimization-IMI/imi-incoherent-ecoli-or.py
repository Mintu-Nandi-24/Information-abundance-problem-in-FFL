# =============================================================================
# FILE: Numerics/CEM-optimization-IMI/imi-incoherent-ecoli-or.py
...
#   ($I_{\mathrm{int}}(X;Z)$) for incoherent FFLs in *E. coli* with an OR
...
#   Run: python imi-incoherent-ecoli-or.py
#
# OUTPUTS
#   Relative output directory: incoherent_ecoli_OR_data/
#   Files: incoherent-ecoli-OR-diagnostics.dat, incoherent-ecoli-OR-best_penalty_convergence.dat, incoherent-ecoli-OR-imi_trajectory.dat, incoherent-ecoli-OR-final_imi_summary.dat, incoherent-ecoli-OR-ratio_satisfaction_scatter.dat, incoherent-ecoli-OR-avg_imi_by_run.dat, incoherent-ecoli-OR-pairwise_distances.dat, incoherent-ecoli-OR-parameter_correlations.dat, incoherent-ecoli-OR-normalized_sensitivity.dat, incoherent-ecoli-OR-parameter_cv.dat, incoherent-ecoli-OR-violin_data.dat, incoherent-ecoli-OR-final_parameter_summary.dat
...
EXPORT_DIR = "incoherent_ecoli_OR_data"
...
def export_all_data(multi_results: Dict[str, Any]):
    ...
    for i in range(multi_results['n_iter']):
        ...
        data1.append(row)
    export_to_dat(
        "incoherent-ecoli-OR-diagnostics.dat",
    ...
    data2 = [[iterations[i], multi_results['best_penalty_mean'][i], multi_results['best_penalty_std'][i]]
             for i in range(multi_results['n_iter'])]
    export_to_dat(
        "incoherent-ecoli-OR-best_penalty_convergence.dat",
    ...
    for i in range(multi_results['n_iter']):
        ...
        data3.append(row)
    export_to_dat(
        "incoherent-ecoli-OR-imi_trajectory.dat",
    ...
    export_to_dat(
        "incoherent-ecoli-OR-final_imi_summary.dat",
    ...
    export_to_dat(
        "incoherent-ecoli-OR-ratio_satisfaction_scatter.dat",
    ...
    export_to_dat(
        "incoherent-ecoli-OR-avg_imi_by_run.dat",
    ...
    if dist_matrix.size > 0:
        ...
        export_to_dat(
            "incoherent-ecoli-OR-pairwise_distances.dat",
            dist_matrix,
            header7,
    ...
    export_to_dat(
        "incoherent-ecoli-OR-parameter_correlations.dat",
        corr_matrix,
        PARAM_NAMES,
    ...
    for p in PARAM_NAMES:
        ...
        data9.append(row)
    export_to_dat(
        "incoherent-ecoli-OR-normalized_sensitivity.dat",
    ...
    export_to_dat(
        "incoherent-ecoli-OR-parameter_cv.dat",
    ...
    export_to_dat(
        "incoherent-ecoli-OR-violin_data.dat",
    ...
    data12 = [[PARAM_NAMES[i], multi_results['theta_means'][i], multi_results['theta_stds'][i]]
              for i in range(len(PARAM_NAMES))]
    export_to_dat(
        "incoherent-ecoli-OR-final_parameter_summary.dat",
