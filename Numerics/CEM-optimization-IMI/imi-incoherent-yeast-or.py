# =============================================================================
# FILE: Numerics/CEM-optimization-IMI/imi-incoherent-yeast-or.py
...
#   ($I_{\mathrm{int}}(X;Z)$) for incoherent FFLs in *S. cerevisiae* / yeast with an OR
#   output gate. The four motifs (I1, I2, I3, I4) share one nine-parameter
#   operating-point vector in each candidate evaluation.
#
# OPTIMIZATION SETUP
#   Target windows: I1/I2 in [4, 8], I1/I3 in [15, 25], I1/I4 in [20, 150].
...
#   Run: python imi-incoherent-yeast-or.py
#
# OUTPUTS
