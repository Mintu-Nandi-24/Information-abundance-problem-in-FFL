# =============================================================================
# FILE: Numerics/CEM-optimization-IMI/imi-coherent-ecoli-or.py
...
#   ($I_{\mathrm{int}}(X;Z)$) for coherent FFLs in *E. coli* with an OR
...
#   Run: python imi-coherent-ecoli-or.py
#
# OUTPUTS
#   Relative output directory: coherent_ecoli_OR_data/
#   Files: coherent-ecoli-OR-diagnostics.dat, coherent-ecoli-OR-best_penalty_convergence.dat, coherent-ecoli-OR-imi_trajectory.dat, coherent-ecoli-OR-final_imi_summary.dat, coherent-ecoli-OR-ratio_satisfaction_scatter.dat, coherent-ecoli-OR-avg_imi_by_run.dat, coherent-ecoli-OR-pairwise_distances.dat, coherent-ecoli-OR-parameter_correlations.dat, coherent-ecoli-OR-normalized_sensitivity.dat, coherent-ecoli-OR-parameter_cv.dat, coherent-ecoli-OR-violin_data.dat, coherent-ecoli-OR-final_parameter_summary.dat
...
EXPORT_DIR = "coherent_ecoli_OR_data"
...
def export_all_data(multi_results: Dict[str, Any]):
    ...
    for i in range(multi_results['n_iter']):
        ...
        data1.append(row)
    export_to_dat(
        "coherent-ecoli-OR-diagnostics.dat",
    ...
    data2 = [[iterations[i], multi_results['best_penalty_mean'][i], multi_results['best_penalty_std'][i]]
             for i in range(multi_results['n_iter'])]
    export_to_dat(
        "coherent-ecoli-OR-best_penalty_convergence.dat",
    ...
    for i in range(multi_results['n_iter']):
        ...
        data3.append(row)
    export_to_dat(
        "coherent-ecoli-OR-imi_trajectory.dat",
    ...
    export_to_dat(
        "coherent-ecoli-OR-final_imi_summary.dat",
    ...
    export_to_dat(
        "coherent-ecoli-OR-ratio_satisfaction_scatter.dat",
    ...
    export_to_dat(
        "coherent-ecoli-OR-avg_imi_by_run.dat",
    ...
    if dist_matrix.size > 0:
        ...
        export_to_dat(
            "coherent-ecoli-OR-pairwise_distances.dat",
            dist_matrix,
            header7,
    ...
    export_to_dat(
        "coherent-ecoli-OR-parameter_correlations.dat",
        corr_matrix,
        PARAM_NAMES,
    ...
    for p in PARAM_NAMES:
        ...
        data9.append(row)
    export_to_dat(
        "coherent-ecoli-OR-normalized_sensitivity.dat",
    ...
    export_to_dat(
        "coherent-ecoli-OR-parameter_cv.dat",
    ...
    export_to_dat(
        "coherent-ecoli-OR-violin_data.dat",
    ...
    data12 = [[PARAM_NAMES[i], multi_results['theta_means'][i], multi_results['theta_stds'][i]]
              for i in range(len(PARAM_NAMES))]
    export_to_dat(
        "coherent-ecoli-OR-final_parameter_summary.dat",
