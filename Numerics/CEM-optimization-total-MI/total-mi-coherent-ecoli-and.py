# =============================================================================
# FILE: Numerics/CEM-optimization-total-MI/total-mi-coherent-ecoli-and.py
...
#
# PURPOSE
#   Performs abundance-guided cross-entropy optimization of total input-output mutual information
#   ($I(X;Z)$) for coherent FFLs in *E. coli* with an AND
...
#   Recommended working directory: Numerics/CEM-optimization-total-MI/
#   Run: python total-mi-coherent-ecoli-and.py
#
# OUTPUTS
