# =============================================================================
# FILE: Numerics/CEM-optimization-total-MI/total-mi-incoherent-ecoli-and.py
...
#   ($I(X;Z)$) for incoherent FFLs in *E. coli* with an AND
...
#   Run: python total-mi-incoherent-ecoli-and.py
#
# OUTPUTS
...
def evaluate_theta(theta: np.ndarray) -> Dict[str, Any]:
    ...
    avg_imi = float(np.mean([imis[m] for m in INCOHERENT_MOTIFS]))
