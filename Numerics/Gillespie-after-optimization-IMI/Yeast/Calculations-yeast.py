# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Yeast/Calculations-yeast.py
...
#
# PURPOSE
#   Combines the Yeast Gillespie outputs for each motif and gate.
...
#
# OUTPUTS
#   sMI-coherent-and-Yeast-num.dat
#   sMI-incoherent-and-Yeast-num.dat
#   sMI-coherent-or-Yeast-num.dat
#   sMI-incoherent-or-Yeast-num.dat
#
...
def compute_group(base_dir: Path, motifs, gate: str, group_name: str):
    ...
    Computes: ffl - ol
    Writes:
      sMI-<group_name>-<gate>-Yeast-num.dat
    """
    out_path = base_dir / f"sMI-{group_name}-{gate}-Yeast-num.dat"
    out_lines = []
