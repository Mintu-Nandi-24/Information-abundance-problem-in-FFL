# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Yeast/OL/OR/yeast-ol-c1-or.py
...
#
# PURPOSE
#   Runs a Gillespie simulation of the C1 matched open-loop (OL) reference in S. cerevisiae (yeast) with an OR output gate and estimates I(X, X_tilde; Z).
...
#   X->Y: activation; X->Z: activation; Y->Z: activation; gate: OR.
#   Simulation time: 5000000.
#   Hard-coded parameter set: <x1>,<x2>,<y>,<z>=(51.13,51.13,53.04,357.06); beta=(0.001223,0.001223,0.076122,0.042529); K=(134.93,294.17,401.08).
...
#   python OL/OR/yeast-ol-c1-or.py
#
# OUTPUT
#   total-MI-abund-c1ol-or-num.dat in the current working directory.
...
with open('total-MI-abund-c1ol-or-num.dat', 'w') as f:
