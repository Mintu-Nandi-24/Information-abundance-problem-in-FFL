# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Yeast/OL/OR/yeast-ol-c2-or.py
...
#
# PURPOSE
#   Runs a Gillespie simulation of the C2 matched open-loop (OL) reference in S. cerevisiae (yeast) with an OR output gate and estimates I(X, X_tilde; Z).
...
#   python OL/OR/yeast-ol-c2-or.py
#
# OUTPUT
#   total-MI-abund-c2ol-or-num.dat in the current working directory.
...
with open('total-MI-abund-c2ol-or-num.dat', 'w') as f:
