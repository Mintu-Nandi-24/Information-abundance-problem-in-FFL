# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Yeast/OL/OR/yeast-ol-i4-or.py
...
#
# PURPOSE
#   Runs a Gillespie simulation of the I4 matched open-loop (OL) reference in S. cerevisiae (yeast) with an OR output gate and estimates I(X, X_tilde; Z).
...
#   python OL/OR/yeast-ol-i4-or.py
#
# OUTPUT
