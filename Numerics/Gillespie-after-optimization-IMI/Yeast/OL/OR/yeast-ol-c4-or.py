# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Yeast/OL/OR/yeast-ol-c4-or.py
...
#
# PURPOSE
#   Runs a Gillespie simulation of the C4 matched open-loop (OL) reference in S. cerevisiae (yeast) with an OR output gate and estimates I(X, X_tilde; Z).
...
#   X->Y: repression; X->Z: activation; Y->Z: repression; gate: OR.
...
#   python OL/OR/yeast-ol-c4-or.py
#
# OUTPUT
#   total-MI-abund-c4ol-or-num.dat in the current working directory.
...
with open('total-MI-abund-c4ol-or-num.dat', 'w') as f:
