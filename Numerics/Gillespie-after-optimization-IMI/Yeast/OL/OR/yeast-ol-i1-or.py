# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Yeast/OL/OR/yeast-ol-i1-or.py
...
#
# PURPOSE
#   Runs a Gillespie simulation of the I1 matched open-loop (OL) reference in S. cerevisiae (yeast) with an OR output gate and estimates I(X, X_tilde; Z).
...
#
# MODEL CONDITION
#   Motif: I1; edge signs (X->Y, X->Z, Y->Z) = (+,+,-).
#   X->Y: activation; X->Z: activation; Y->Z: repression; gate: OR.
#   Simulation time: 5000000.
#   Hard-coded parameter set: <x1>,<x2>,<y>,<z>=(112.8,112.8,431.18,206.83); beta=(0.0010933,0.0010933,0.044021,0.088137); K=(261.24,272.19,22.59).
...
#   python OL/OR/yeast-ol-i1-or.py
#
# OUTPUT
#   total-MI-abund-i1ol-or-num.dat in the current working directory.
...
with open('total-MI-abund-i1ol-or-num.dat', 'w') as f:
