# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Yeast/OL/OR/yeast-ol-c3-or.py
...
#
# PURPOSE
#   Runs a Gillespie simulation of the C3 matched open-loop (OL) reference in S. cerevisiae (yeast) with an OR output gate and estimates I(X, X_tilde; Z).
...
#   X->Y: activation; X->Z: repression; Y->Z: repression; gate: OR.
...
#   python OL/OR/yeast-ol-c3-or.py
#
# OUTPUT
#   total-MI-abund-c3ol-or-num.dat in the current working directory.
...
with open('total-MI-abund-c3ol-or-num.dat', 'w') as f:
