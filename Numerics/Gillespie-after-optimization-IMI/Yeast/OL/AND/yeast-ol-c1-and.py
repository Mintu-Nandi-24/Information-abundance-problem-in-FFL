# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Yeast/OL/AND/yeast-ol-c1-and.py
...
#
# PURPOSE
#   Runs a Gillespie simulation of the C1 matched open-loop (OL) reference in S. cerevisiae (yeast) with an AND output gate and estimates I(X, X_tilde; Z).
...
#   python OL/AND/yeast-ol-c1-and.py
#
# OUTPUT
