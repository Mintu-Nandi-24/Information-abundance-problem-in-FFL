# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Yeast/OL/AND/yeast-ol-i3-and.py
...
#
# PURPOSE
#   Runs a Gillespie simulation of the I3 matched open-loop (OL) reference in S. cerevisiae (yeast) with an AND output gate and estimates I(X, X_tilde; Z).
...
#   python OL/AND/yeast-ol-i3-and.py
#
# OUTPUT
