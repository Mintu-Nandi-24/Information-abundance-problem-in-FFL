# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Yeast/OL/AND/yeast-ol-c4-and.py
...
#
# PURPOSE
#   Runs a Gillespie simulation of the C4 matched open-loop (OL) reference in S. cerevisiae (yeast) with an AND output gate and estimates I(X, X_tilde; Z).
...
#
# MODEL CONDITION
#   Motif: C4; edge signs (X->Y, X->Z, Y->Z) = (-,+,-).
#   X->Y: repression; X->Z: activation; Y->Z: repression; gate: AND.
#   Simulation time: 5000000.
#   Hard-coded parameter set: <x1>,<x2>,<y>,<z>=(50,50,63.42,499.96); beta=(0.012336,0.012336,0.00904,0.02863); K=(467.23,27.69,499.8).
...
#   python OL/AND/yeast-ol-c4-and.py
#
# OUTPUT
#   total-MI-abund-c4ol-and-num.dat in the current working directory.
...
with open('total-MI-abund-c4ol-and-num.dat', 'w') as f:
