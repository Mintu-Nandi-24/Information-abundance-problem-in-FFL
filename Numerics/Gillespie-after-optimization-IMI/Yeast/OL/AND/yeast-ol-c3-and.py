# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Yeast/OL/AND/yeast-ol-c3-and.py
...
#
# PURPOSE
#   Runs a Gillespie simulation of the C3 matched open-loop (OL) reference in S. cerevisiae (yeast) with an AND output gate and estimates I(X, X_tilde; Z).
...
#   python OL/AND/yeast-ol-c3-and.py
#
# OUTPUT
#   total-MI-abund-c3ol-and-num.dat in the current working directory.
...
with open('total-MI-abund-c3ol-and-num.dat', 'w') as f:
