# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Yeast/FFL/AND/yeast-ffl-c1-and.py
...
#
# PURPOSE
#   Runs a direct Gillespie simulation of the C1 feed-forward-loop (FFL) in S. cerevisiae (yeast) with an AND output gate and estimates total Gaussian MI I(X;Z).
...
#   python FFL/AND/yeast-ffl-c1-and.py
#
# OUTPUT
#   total-MI-abund-c1ffl-and-num.dat in the current working directory.
...
with open('total-MI-abund-c1ffl-and-num.dat', 'w') as f:
