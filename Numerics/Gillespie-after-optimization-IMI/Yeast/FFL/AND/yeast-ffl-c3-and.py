# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Yeast/FFL/AND/yeast-ffl-c3-and.py
...
#
# PURPOSE
#   Runs a direct Gillespie simulation of the C3 feed-forward-loop (FFL) in S. cerevisiae (yeast) with an AND output gate and estimates total Gaussian MI I(X;Z).
...
#
# MODEL CONDITION
#   Motif: C3; edge signs (X->Y, X->Z, Y->Z) = (+,-,-).
#   X->Y: activation; X->Z: repression; Y->Z: repression; gate: AND.
#   Simulation time: 1000000.
#   Hard-coded parameter set: <x>,<y>,<z>=(50,63.42,499.96); beta=(0.012336,0.00904,0.02863); K=(467.23,27.69,499.8).
...
#   python FFL/AND/yeast-ffl-c3-and.py
#
# OUTPUT
#   total-MI-abund-c3ffl-and-num.dat in the current working directory.
...
with open('total-MI-abund-c3ffl-and-num.dat', 'w') as f:
