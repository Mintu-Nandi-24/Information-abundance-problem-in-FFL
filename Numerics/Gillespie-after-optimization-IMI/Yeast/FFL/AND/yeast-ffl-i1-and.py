# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Yeast/FFL/AND/yeast-ffl-i1-and.py
...
#
# PURPOSE
#   Runs a direct Gillespie simulation of the I1 feed-forward-loop (FFL) in S. cerevisiae (yeast) with an AND output gate and estimates total Gaussian MI I(X;Z).
...
#   python FFL/AND/yeast-ffl-i1-and.py
#
# OUTPUT
