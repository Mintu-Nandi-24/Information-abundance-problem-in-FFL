# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Yeast/FFL/AND/yeast-ffl-c2-and.py
...
#
# PURPOSE
#   Runs a direct Gillespie simulation of the C2 feed-forward-loop (FFL) in S. cerevisiae (yeast) with an AND output gate and estimates total Gaussian MI I(X;Z).
...
#   X->Y: repression; X->Z: repression; Y->Z: activation; gate: AND.
...
#   python FFL/AND/yeast-ffl-c2-and.py
#
# OUTPUT
#   total-MI-abund-c2ffl-and-num.dat in the current working directory.
...
with open('total-MI-abund-c2ffl-and-num.dat', 'w') as f:
