# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Yeast/FFL/OR/yeast-ffl-c3-or.py
...
#
# PURPOSE
#   Runs a direct Gillespie simulation of the C3 feed-forward-loop (FFL) in S. cerevisiae (yeast) with an OR output gate and estimates total Gaussian MI I(X;Z).
...
#   Hard-coded parameter set: <x>,<y>,<z>=(51.13,53.04,357.06); beta=(0.001223,0.076122,0.042529); K=(134.93,294.17,401.08).
...
#   python FFL/OR/yeast-ffl-c3-or.py
#
# OUTPUT
#   total-MI-abund-c3ffl-or-num.dat in the current working directory.
...
with open('total-MI-abund-c3ffl-or-num.dat', 'w') as f:
