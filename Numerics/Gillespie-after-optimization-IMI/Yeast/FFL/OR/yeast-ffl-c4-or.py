# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Yeast/FFL/OR/yeast-ffl-c4-or.py
...
#
# PURPOSE
#   Runs a direct Gillespie simulation of the C4 feed-forward-loop (FFL) in S. cerevisiae (yeast) with an OR output gate and estimates total Gaussian MI I(X;Z).
...
#   python FFL/OR/yeast-ffl-c4-or.py
#
# OUTPUT
#   total-MI-abund-c4ffl-or-num.dat in the current working directory.
...
with open('total-MI-abund-c4ffl-or-num.dat', 'w') as f:
