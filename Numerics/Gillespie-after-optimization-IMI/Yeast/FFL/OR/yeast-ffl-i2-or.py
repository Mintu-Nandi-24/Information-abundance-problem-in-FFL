# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Yeast/FFL/OR/yeast-ffl-i2-or.py
...
#
# PURPOSE
#   Runs a direct Gillespie simulation of the I2 feed-forward-loop (FFL) in S. cerevisiae (yeast) with an OR output gate and estimates total Gaussian MI I(X;Z).
...
#   python FFL/OR/yeast-ffl-i2-or.py
#
# OUTPUT
#   total-MI-abund-i2ffl-or-num.dat in the current working directory.
...
with open('total-MI-abund-i2ffl-or-num.dat', 'w') as f:
