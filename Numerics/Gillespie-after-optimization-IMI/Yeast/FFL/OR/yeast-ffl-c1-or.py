# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Yeast/FFL/OR/yeast-ffl-c1-or.py
...
#
# PURPOSE
#   Runs a direct Gillespie simulation of the C1 feed-forward-loop (FFL) in S. cerevisiae (yeast) with an OR output gate and estimates total Gaussian MI I(X;Z).
...
#   python FFL/OR/yeast-ffl-c1-or.py
#
# OUTPUT
#   total-MI-abund-c1ffl-or-num.dat in the current working directory.
...
with open('total-MI-abund-c1ffl-or-num.dat', 'w') as f:
