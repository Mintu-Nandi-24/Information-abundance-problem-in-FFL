# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Yeast/FFL/OR/yeast-ffl-i1-or.py
...
#
# PURPOSE
#   Runs a direct Gillespie simulation of the I1 feed-forward-loop (FFL) in S. cerevisiae (yeast) with an OR output gate and estimates total Gaussian MI I(X;Z).
...
#   Hard-coded parameter set: <x>,<y>,<z>=(112.8,431.18,206.83); beta=(0.0010933,0.044021,0.088137); K=(261.24,272.19,22.59).
...
#   python FFL/OR/yeast-ffl-i1-or.py
#
# OUTPUT
#   total-MI-abund-i1ffl-or-num.dat in the current working directory.
...
with open('total-MI-abund-i1ffl-or-num.dat', 'w') as f:
