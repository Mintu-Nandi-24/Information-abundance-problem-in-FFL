# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Ecoli/FFL/AND/ecoli-ffl-i1-and.py
...
#
# PURPOSE
#   Runs a direct Gillespie simulation of the I1 feed-forward-loop (FFL) in E. coli with an AND output gate and estimates total Gaussian MI I(X;Z).
...
#   X->Y: activation; X->Z: activation; Y->Z: repression; gate: AND.
#   Simulation time: 1000000.
#   Hard-coded parameter set: <x>,<y>,<z>=(15.93,48.82,56.96); beta=(0.0050023,0.098712,0.7257); K=(54.32,99.55,37.29).
...
#   python FFL/AND/ecoli-ffl-i1-and.py
#
# OUTPUT
#   total-MI-abund-i1ffl-and-num.dat in the current working directory.
...
with open('total-MI-abund-i1ffl-and-num.dat', 'w') as f:
