# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Ecoli/FFL/AND/ecoli-ffl-i3-and.py
...
#
# PURPOSE
#   Runs a direct Gillespie simulation of the I3 feed-forward-loop (FFL) in E. coli with an AND output gate and estimates total Gaussian MI I(X;Z).
...
#   python FFL/AND/ecoli-ffl-i3-and.py
#
# OUTPUT
#   total-MI-abund-i3ffl-and-num.dat in the current working directory.
...
with open('total-MI-abund-i3ffl-and-num.dat', 'w') as f:
