# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Ecoli/FFL/AND/ecoli-ffl-c3-and.py
...
#
# PURPOSE
#   Runs a direct Gillespie simulation of the C3 feed-forward-loop (FFL) in E. coli with an AND output gate and estimates total Gaussian MI I(X;Z).
...
#   Hard-coded parameter set: <x>,<y>,<z>=(10.64,13.17,99.94); beta=(0.0050007,0.099884,0.49986); K=(63.52,69.95,18.4).
...
#   python FFL/AND/ecoli-ffl-c3-and.py
#
# OUTPUT
