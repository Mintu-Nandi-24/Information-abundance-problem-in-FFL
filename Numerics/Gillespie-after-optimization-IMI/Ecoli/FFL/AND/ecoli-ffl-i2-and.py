# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Ecoli/FFL/AND/ecoli-ffl-i2-and.py
...
#
# PURPOSE
#   Runs a direct Gillespie simulation of the I2 feed-forward-loop (FFL) in E. coli with an AND output gate and estimates total Gaussian MI I(X;Z).
...
#   python FFL/AND/ecoli-ffl-i2-and.py
#
# OUTPUT
#   total-MI-abund-i2ffl-and-num.dat in the current working directory.
...
with open('total-MI-abund-i2ffl-and-num.dat', 'w') as f:
