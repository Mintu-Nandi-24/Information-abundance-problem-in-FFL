# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Ecoli/FFL/AND/ecoli-ffl-c1-and.py
...
#
# PURPOSE
#   Runs a direct Gillespie simulation of the C1 feed-forward-loop (FFL) in E. coli with an AND output gate and estimates total Gaussian MI I(X;Z).
...
#   python FFL/AND/ecoli-ffl-c1-and.py
#
# OUTPUT
