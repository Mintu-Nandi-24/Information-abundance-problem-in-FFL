# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Ecoli/FFL/OR/ecoli-ffl-c3-or.py
...
#
# PURPOSE
#   Runs a direct Gillespie simulation of the C3 feed-forward-loop (FFL) in E. coli with an OR output gate and estimates total Gaussian MI I(X;Z).
...
#   python FFL/OR/ecoli-ffl-c3-or.py
#
# OUTPUT
