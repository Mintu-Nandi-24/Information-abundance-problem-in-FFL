# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Ecoli/FFL/OR/ecoli-ffl-i1-or.py
...
#
# PURPOSE
#   Runs a direct Gillespie simulation of the I1 feed-forward-loop (FFL) in E. coli with an OR output gate and estimates total Gaussian MI I(X;Z).
...
#   Hard-coded parameter set: <x>,<y>,<z>=(10.12,39.82,99.83); beta=(0.034645,0.062942,0.26985); K=(34.95,44.2,21.86).
...
#   python FFL/OR/ecoli-ffl-i1-or.py
#
# OUTPUT
