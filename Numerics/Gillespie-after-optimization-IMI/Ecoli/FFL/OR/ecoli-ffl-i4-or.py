# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Ecoli/FFL/OR/ecoli-ffl-i4-or.py
...
#
# PURPOSE
#   Runs a direct Gillespie simulation of the I4 feed-forward-loop (FFL) in E. coli with an OR output gate and estimates total Gaussian MI I(X;Z).
...
#   python FFL/OR/ecoli-ffl-i4-or.py
#
# OUTPUT
