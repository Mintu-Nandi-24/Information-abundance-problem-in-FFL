# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Ecoli/OL/AND/ecoli-ol-c2-and.py
...
#
# PURPOSE
#   Runs a Gillespie simulation of the C2 matched open-loop (OL) reference in E. coli with an AND output gate and estimates I(X, X_tilde; Z).
...
#   python OL/AND/ecoli-ol-c2-and.py
#
# OUTPUT
