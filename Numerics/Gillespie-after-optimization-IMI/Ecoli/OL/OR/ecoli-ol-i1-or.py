# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Ecoli/OL/OR/ecoli-ol-i1-or.py
...
#
# PURPOSE
#   Runs a Gillespie simulation of the I1 matched open-loop (OL) reference in E. coli with an OR output gate and estimates I(X, X_tilde; Z).
...
#   python OL/OR/ecoli-ol-i1-or.py
#
# OUTPUT
