# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Ecoli/OL/OR/ecoli-ol-c1-or.py
...
#
# PURPOSE
#   Runs a Gillespie simulation of the C1 matched open-loop (OL) reference in E. coli with an OR output gate and estimates I(X, X_tilde; Z).
...
#   python OL/OR/ecoli-ol-c1-or.py
#
# OUTPUT
