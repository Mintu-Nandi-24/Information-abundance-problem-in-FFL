# =============================================================================
# FILE: Numerics/Gillespie-after-optimization-IMI/Ecoli/OL/OR/ecoli-ol-c3-or.py
...
#
# PURPOSE
#   Runs a Gillespie simulation of the C3 matched open-loop (OL) reference in E. coli with an OR output gate and estimates I(X, X_tilde; Z).
...
#   Hard-coded parameter set: <x1>,<x2>,<y>,<z>=(10,10,17.25,99.95); beta=(0.013426,0.013426,0.093002,0.27098); K=(64.61,41.42,26.9).
...
#   python OL/OR/ecoli-ol-c3-or.py
#
# OUTPUT
